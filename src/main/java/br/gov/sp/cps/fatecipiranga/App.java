...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        for (int rodadaAtual = 1; rodadaAtual <= numRodadas; rodadaAtual++) {
            ...
            while (true) {
                ...
                if (quemComeca == 0) {
                    ...
                    if (policial.getEnergia() <= 0) {
                        ...
                        vitoriasTerrorista++;
                        jogoDao.inserirResultado("terrorista-" + terrorista.getNomeTerrorista(),
                                "venceu matando " + policial.getNomePolicial(), rodadaAtual);
                        break;
                    }
                    ...
                    if (terrorista.getEnergia() <= 0) {
                        ...
                        vitoriasPolicial++;
                        jogoDao.inserirResultado("policial-" + policial.getNomePolicial(),
                                "venceu matando " + terrorista.getNomeTerrorista(), rodadaAtual);
                        break;
                    }
                } else {
                    int acaoPolicial = random.nextInt(4);
                ...
                if (bombaFoiPlantada == true) {
                    if (bombaFoiDesarmada == false) {
                        ...
                        vitoriasTerrorista++;
                        jogoDao.inserirResultado("terrorista-" + terrorista.getNomeTerrorista(),
                                "venceu explodindo o " + policial.getNomePolicial(), rodadaAtual);
                        break;
                    }
                    if (bombaFoiDesarmada == true) {
                        ...
                        vitoriasPolicial++;
                        jogoDao.inserirResultado("policial-" + policial.getNomePolicial(), "venceu desarmando a bomba ",
                                rodadaAtual);
                        break;
                    }
                }
            ...
            System.out.println("\n--- [ATAQUES] - [RODADA]:" + rodadaAtual + " ------");
            System.out.println(terrorista.getNomeTerrorista() + ": " + terrorista.getAtkLog());
            System.out.println(policial.getNomePolicial() + ": " + policial.getAtkLog());
            System.out.println("---------------------------------------------------------\n");
        }
